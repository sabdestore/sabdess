...
echo -e "  Auther : ${green}Sabde Store® ${NC}${YELLOW}(${NC} ${green} Bogel Store Tunneling ${NC}${YELLOW})${NC}"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/sabdee/vip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/sabdee/vip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/sabdee/vip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/sabdee/vip/main/"
...
echo -e "     \e[1;32m2)\e[0m Gunakan Domain Random ✖️ "
echo -e "   ------------------------------------"
...
wget raw.githubusercontent.com/sabdee/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
